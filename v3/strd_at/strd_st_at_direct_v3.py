...
def run_task_rd(s_init):
    ...
    for z_1, z_2 in [[0.9, 0.1], [0.5, 0.5]]:
        ...
        for _ in t:
            ...
            dp0 = (calc_payoff(0, 0, 1, q0, qvec, pl, ql, f_p_exp, f_q_exp) - calc_payoff(0, 0, p0, q0, qvec, pl, ql,
                                                                                          f_p_exp, f_q_exp)) * p0 * v_0
            dq0 = (calc_payoff(1, 0, p0, 1, qvec, pl, ql, f_p_exp, f_q_exp) - calc_payoff(1, 0, p0, q0, qvec, pl, ql,
                                                                                          f_p_exp, f_q_exp)) * q0 * v_0
            dp1 = (calc_payoff(0, 1, 1, q1, qvec, pl, ql, f_p_exp, f_q_exp) - calc_payoff(0, 1, p1, q1, qvec, pl, ql,
                                                                                          f_p_exp, f_q_exp)) * p1 * v_1
            dq1 = (calc_payoff(1, 1, p1, 1, qvec, pl, ql, f_p_exp, f_q_exp) - calc_payoff(1, 1, p1, q1, qvec, pl, ql,
