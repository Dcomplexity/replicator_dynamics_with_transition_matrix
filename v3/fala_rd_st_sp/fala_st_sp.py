...
# transition_prob = [0.1, 0.1, 0.1, 0.9, 0.1, 0.1, 0.1, 0.9] # asymmetric
# transition_prob = [0.5, 0.3, 0.9, 0.7, 0.3, 0.1, 0.7, 0.5] # zero-determinant
# transition_prob = [18/40, 39/40, 6/40, 27/40, 14/40, 35/40, 2/40, 23/40] # exploitation
...
def run_task_fala(s_init):
    ...
    abs_path = os.path.abspath(os.path.join(os.getcwd(), "./results_st_sp"))
