...
pd_game_1 = [[3, 7], [7, 2], [9, 6], [2, 9]]
pd_game_2 = [[9, 8], [2, 5], [1, 2], [6, 9]]

# transition_prob = [[0.9, 0.1], [0.1, 0.9], [0.1, 0.9], [0.9, 0.1],
#                    [0.1, 0.9], [0.9, 0.1], [0.9, 0.1], [0.1, 0.9]]
transition_prob = [[0.3, 0.7], [0.4, 0.6], [0.2, 0.8], [0.9, 0.1],
                   [0.6, 0.4], [0.8, 0.2], [0.5, 0.5], [0.4, 0.6]]
...
def run_task_fala(s_init):
    ...
    abs_path = os.path.abspath(os.path.join(os.getcwd(), "results_st_random"))
