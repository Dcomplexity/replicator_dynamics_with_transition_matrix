# This code is to find how transition probabiliies between states affect the equilibrium.
...
def run_task():
    ...
    s_n = 2
    p_2 = 0.1
    p_init = [0.5, 0.5, 0.0, 0.0]
    for p_1 in [0.9, 0.7, 0.5, 0.3, 0.1]:
        print(p_1, p_2)
        ...
        for q0 in q0_sub:
            ...
            abs_path = os.path.abspath(os.path.join(os.getcwd(), "./results_direction"))
            csv_file_name = "/p1_%.1f_p2_%.1f_strategy_tp.csv" % (p_1, p_2)
